...
&= r_{2z} + r_{12} r_{1z}
\end{align*}
In the last line we make use of the fact that $\mathbf{x_1^2} = 1$. Putting it all together the bias of omitting the term $\mathbf{x_1 z}$ on the estimate of $\beta^{p3}_{12}$ is 
\begin{equation*}
\gamma_1 \frac{r_{2z} + r_{12} r_{1z}}{var(\mathbf{x_1 z})}
\end{equation*}
Similarly, the bias of omitting the term $\mathbf{x_1 z}$ on the estimate of $\beta^{p3}_{12}$ is 
\begin{equation*}
\gamma_2 \frac{r_{1z} + r_{12} r_{2z}}{var(\mathbf{x_2 z})}
\end{equation*}
The bias of omitting the terms $\mathbf{x_1^2}$ and $\mathbf{x_2^2}$ is respectively
\begin{align*}
\frac{3 \delta_1 r_{12}}{var(\mathbf{x_1^2)}} \text{and} \frac{3 \delta_2 r_{12}}{var(\mathbf{x_2^2)}}
\end{align*}
